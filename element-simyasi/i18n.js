...
const STRINGS = {
	tr: {
		...
		dailyTitle: "🗓️ Günün Elementi", dailyGoal: "Bugünkü hedef",
		dailyDone: "Günün elementini buldun!", dailyStreak: "gün seri",
		dailyHintBtn: "💡 İpucu", dailyFoundLabel: "✅ Bulundu",
		replayTutorial: "📖 Tanıtımı tekrar göster",
		tutSkip: "Geç", tutNext: "İleri", tutDone: "Başla!",
		tut1Title: "🧪 Element Simyası'na hoş geldin!",
		tut1Body: "Ateş, Su, Toprak ve Hava ile başla; onları birleştirerek SINIRSIZ yeni element keşfet.",
		tut2Title: "🔀 Nasıl birleştirilir?",
		tut2Body: "Tuvalde bir elementi sürükleyip diğerinin üstüne bırak. Telefonda alttaki panelden iki elemente dokunman da yeter — sonuç anında doğar.",
		tut3Title: "🔍 Panel & arama",
	...
	en: {
		...
		dailyTitle: "🗓️ Element of the Day", dailyGoal: "Today's target",
		dailyDone: "You found today's element!", dailyStreak: "day streak",
		dailyHintBtn: "💡 Hint", dailyFoundLabel: "✅ Found",
		replayTutorial: "📖 Replay intro",
		tutSkip: "Skip", tutNext: "Next", tutDone: "Start!",
		tut1Title: "🧪 Welcome to Element Alchemy!",
		tut1Body: "Start with Fire, Water, Earth and Air — combine them to discover ENDLESS new elements.",
		tut2Title: "🔀 How to combine?",
		tut2Body: "Drag an element on the canvas onto another. On phones, just tap two elements in the bottom panel — the result appears instantly.",
		tut3Title: "🔍 Panel & search",
