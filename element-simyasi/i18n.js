...
const STRINGS = {
	tr: {
		...
		sortRecent: "En yeni", sortName: "İsim (A-Z)", sortRarity: "Nadirlik", sortDepth: "Derinlik", sortCat: "Kategori",
		folders: "Favori klasörleri", foldersTitle: "🗂️ Favori Klasörleri",
		foldersHint: "Favori elementlerini klasörlere ayırıp panelde gruplandır.",
		folderName: "Klasör adı", addFolder: "Ekle", assignTitle: "Elementleri klasörle",
		allFavorites: "⭐ Favoriler", noFavorites: "Henüz favori yok — bir elementin yıldızına dokun.",
		noFolder: "Klasörsüz", deleteFolder: "Sil",
		// Element detayı
		lineage: "🌳 Soy Ağacı",
	...
	en: {
		...
		sortRecent: "Newest", sortName: "Name (A-Z)", sortRarity: "Rarity", sortDepth: "Depth", sortCat: "Category",
		folders: "Favorite folders", foldersTitle: "🗂️ Favorite Folders",
		foldersHint: "Group your favorite elements into folders shown in the panel.",
		folderName: "Folder name", addFolder: "Add", assignTitle: "Assign elements",
		allFavorites: "⭐ Favorites", noFavorites: "No favorites yet — tap an element's star.",
		noFolder: "No folder", deleteFolder: "Delete",
		lineage: "🌳 Family Tree",
